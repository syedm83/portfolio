...
export const About = () => {
    ...
    return <section id="about" className="min-h-screen flex items-center justify-center py-20">
        ...
        <div className="max-w-3xl mx-auto px-4">
            ...
            <div className="rounded-xl p-8 border-teal-200/50 border hover:-translate-y-1 transition-all"> 
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                <div className="rounded-xl p-3 hover:-translate-y-1 transition-all">
                    <h3 className="text-xl font-bold mb-3 text-indigo-300">Languages</h3>
                    <div className="flex flex-wrap gap-2">
                        {languageSkills.map((tech, key) => (
                            <span key={key} className="bg-teal-500/10 text-teal-600 py-1 px-3 rounded-full text-sm hover:bg-blue-500/20 
                ...
                <div className="rounded-xl p-3 hover:-translate-y-1 transition-all">
                    <h3 className="text-xl font-bold mb-3 text-indigo-300">Frameworks</h3>
                    <div className="flex flex-wrap gap-2">
                ...
                <div className="rounded-xl p-3 hover:-translate-y-1 transition-all">
                    <h3 className="text-xl font-bold mb-3 text-indigo-300">Developer Tools</h3>
                    <div className="flex flex-wrap gap-2">
                ...
                <div className="rounded-xl p-3 hover:-translate-y-1 transition-all">
                    <h3 className="text-xl font-bold mb-3 text-indigo-300">Libraries</h3>
                    <div className="flex flex-wrap gap-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                <div className="p-6 rounded-xl border-teal-200/50 border hover:-translate-y-1 transition-all">
                ...
                <div className="p-6 rounded-xl border-teal-200/50 border hover:-translate-y-1 transition-all">
                    <h3 className="text-xl font-bold mb-4 text-indigo-400">🖥️ Work Experience</h3>
