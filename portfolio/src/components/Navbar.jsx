...
export const Navbar = ({menuOpen, setMenuOpen}) =>{
    ...
    return (
    <nav className="fixed top-0 w-full z-40 bg-[rgba(227, 227, 227, 0.8)] backdrop-blur-lg border-b border-white/10 shadow-lg">
        <div className="max-w-5xl mx-auto px-4">
            <div className="flex justify-between items-center h-16">
                ...
                <div className="hidden md:flex items-center space-x-8">
                    ...
                    <a href="#about" className="tex-gray-300 hove:text-white transition-colors">{""}About Me{""} </a>
